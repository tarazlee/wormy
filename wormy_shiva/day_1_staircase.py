...
TRAINING = 201 # how many training trials to do
NOTIMELIMIT = TRAINING / 5
...
def main():
	...
	frame.to_csv('%s_temp_day1.csv' % subject_number, sep= '\t')
    frame.to_csv('%s_day1_training.csv' % subject_number, sep= '\t') #write output
    stairSize =[np.mean(reversalSizes)]
    stairSpeed = [np.mean(reversalTimes)]
    ...
    stairFrame.to_csv('%s_day_1_params.csv' % subject_number, sep = '\t')
