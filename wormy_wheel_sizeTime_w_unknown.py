...
TRAINING = 150 # how many training trials to do
...
def main():
    ...
    for i in range(numTrials):
        ...
        if trial_outcome == 3: 
            ...
            elif i >= TRAINING / 4 and doStaircase == 'yes': # for speed staircasing
...
def runGame(targetSize, trialNum, rewardVal,startingSides, maxTime):
    ...
    while True: # main game loop
        ...
        if curr_time < WAITTIME: 
            ...
            if curr_time > maxTime and (trialNum > TRAINING / 4 or rewardVal !='0'):
